...
$custom_reviewer_id = ($user_role === 'reviewer') ? "R" . str_pad($user_id, 3, "0", STR_PAD_LEFT) : ucfirst($user_role) . " ID: " . $user_id;
...
<div class="main-content">
    <header class="dashboard-header">
        ...
        <div style="text-align: right;">
            <span style="font-weight: 800; display: block;">ID: <?php echo htmlspecialchars($custom_reviewer_id); ?></span>
